...
function ag_pag($total,$courante,$adjacentes,$ThisFile,$css) {
   ...
   if($total > 1) {
      ...
      if ($courante == 2)
         $pagination.= '
                        <li class="page-item"><a class="page-link" href="'.$ThisFile.'">◄</a></li>';
      elseif ($courante > 2)
         $pagination.= '
                        <li class="page-item"><a class="page-link" href="'.$ThisFile.'&amp;page='.$prec.'">◄</a></li>';
      else
         $pagination.= '<li class="page-item disabled"><a class="page-link" href="#">◄</a></li>';
      if ($total < 7 + ($adjacentes * 2)) {
         $pagination.= ($courante == 1) ? 
                        '<li class="page-item active"><span class="page-link">1</span></li>' : 
                        '<li class="page-item"><a class="page-link" href="'.$ThisFile.'">1</a></li>';
         for ($compteur = 2; $compteur <= $total; $compteur++) {
            $pagination.= $compteur == $courante ?
                        '<li class="page-item active"><span class="page-link">'.$compteur.'</span></li>' :
                        '<li class="page-item"><a class="page-link" href="'.$ThisFile.'&amp;page='.$compteur.'">'.$compteur.'</a></li>' ;
         }
      }
      elseif($total > 5 + ($adjacentes * 2)) {
         if($courante < 1 + ($adjacentes * 2)) {
            ...
            $pagination.= '
                        ...
                        <li class="page-item"><a class="page-link" href="'.$ThisFile.'&amp;page='.$avder.'">'.$avder.'</a></li>
                        <li class="page-item"><a class="page-link" href="'.$ThisFile.'&amp;page='.$total.'">'.$total.'</a></li>';
         }
         elseif($total - ($adjacentes * 2) > $courante && $courante > ($adjacentes * 2)) {
            $pagination.= '
                        <li class="page-item"><a class="page-link" href="'.$ThisFile.'">1</a></li>
                        <li class="page-item"><a class="page-link" href="'.$ThisFile.'&amp;page=2">2</a></li>
                        <li class="page-item"><a class="page-link" href=""> ... </a></li>';
      ...
      $pagination.= $courante < $compteur - 1 ?
                        '<li class="page-item"><a class="page-link" href="'.$ThisFile.'&amp;page='.$suiv.'">►</a></li>' :
